...
import {
    Container, Grid, ThemeIcon, Text, Group, Badge, Paper, Center, ActionIcon
    , SimpleGrid
} from "@mantine/core";
import { IconUsers, IconDesk, IconNotes, IconChevronRight } from '@tabler/icons-react';
                        ...
                        <Grid>
                            ...
                            <Grid.Col span={{ base: 12, xs: 8 }}>
                                ...
                                <Group justify="space-between">
                                    ...
                                    <Badge size="md" color='green.7'>Now</Badge>
                                </Group>
                            </Grid.Col>
                        </Grid>
                    </Paper>
